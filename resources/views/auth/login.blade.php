                            ...
                            <div class="my-auto">
                                ...
                                <form class="mt-4 pt-2" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="email" type="text" class="w-full rounded placeholder:text-sm py-2 border-gray-100 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60" id="username" placeholder="Enter username">

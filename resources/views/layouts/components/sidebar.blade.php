                            ...
                            <div class="border border-gray-50 dark:border-zinc-600" aria-labelledby="navNotifications">
                                ...
                                <div class="dropdown-item dark:text-gray-100">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <a class="p-3 hover:bg-gray-50/50 block dark:hover:bg-zinc-700/50" href="#" onclick="event.preventDefault();
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    @foreach ($listMenu as $dataMenu)
                        <li class="menu-heading px-4 py-3.5 text-xs font-medium text-gray-500 cursor-default" data-key="t-menu">{{$dataMenu['title']}}</li>
                            ...
                            <li>
                                ...
                                <ul>
                                    @foreach ($menu['submenu'] as $submenu)
                                        <li>
                                            <a href="app-calendar.html" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{$submenu['label']}}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
